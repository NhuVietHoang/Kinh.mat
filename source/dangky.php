...
<body>
    <?php 
        include("menu.php");
    ?>
	<form action="register_submit.php" method="POSt" style="height: auto;">
		<div class="bao"><div class="logo1"><img class="logo-img" src="image/logo.png"></div></div>
		<h2>Đăng ký</h2>
		<input  id="id-value1" class="f-input" type="text" name="name" placeholder="name" value="" required>
        <input id="id-value1" class="f-input" type="text" name="phone" placeholder="phone" value="" required>
        <input id="id-value1" class="f-input" type="text" name="address" placeholder="address" value="" required>
		<input id="id-value2" class="f-input" type="password" name="password" placeholder="password" value="" required>
		<input type="submit" name="submit"  class="btn-dangnhap">
		<!-- <button id="id-dangnhap" class="btn-dangnhap" type="submit"><a id="id-trangchu">Đăng kí</a></button>	 -->
	</form>
		...
		<div class="footer">
			<div class="f1">
				...
				<div class="fp">
					...
					<span class="fp2">0373177267</span>
				</div>
				<div class="fp">
				...
				<div class="fp">
					...
					<span class="fp2">viethoangnhu@gmail.com</span>
				</div>
