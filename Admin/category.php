...
<?php 
	...
	$sql = mysqli_query($mysqli,$category);
?>
</head>
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.php">Kính Mắt Việt</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="active"><a href="category.php"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad"/></svg> Danh mục</a></li>
			<li role="presentation" class="divider"></li>
		</ul>
							...
							<table class="table table-bordered">
				              	...
				              	<tbody>
									  <?php 
										foreach($sql as $q){ ?>
											<tr>
												<td><?php echo $q['name_trademark'] ?></td>
												<td>
